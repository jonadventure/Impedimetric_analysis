...
class App:
    ...
    def info_box2(self):
        if self.clicked.get() == self.options[0]:
            Text = "The column for Potential values in the excel/csv file. List the number of that column."
        elif self.clicked.get() == self.options[1]:
            Text = "The column for Real part impedance values in the excel/csv file. List the number of that column."
        elif self.clicked.get() == self.options[2]:
            Text = "The column for x-values in the excel/csv file. List the number of that column."
        tk.messagebox.showinfo("Info",str(Text))
    
    def info_box3(self):
        if self.clicked.get() == self.options[0]:
            Text = "The column for Current values in the excel/csv file. List the number of that column."
        elif self.clicked.get() == self.options[1]:
            Text = "The column for Imaginary part impedance values in the excel/csv file. List the number of that column."
        elif self.clicked.get() == self.options[2]:
            Text = "The column for y-values in the excel/csv file. List the number of that column."
        tk.messagebox.showinfo("Info",str(Text))
    
    def info_box4(self):
        if self.clicked.get() == self.options[0]:
            Text = "The column for Scan number indication in the excel/csv file. List the number of that column. If NONE, please insert 0 instead."
        elif self.clicked.get() == self.options[1]:
            Text = "Insert value for Start interval of Real part impedance values. NB: both Z_R_start and Z_R_end must be inserted for the interval range to be created."
        elif self.clicked.get() == self.options[2]:
    ...
    def info_box5(self):
        if self.clicked.get() == self.options[0]:
            Text = "The Scan number value to select for plotting."
        elif self.clicked.get() == self.options[1]:
            Text = "Insert value for End interval of Real part impedance values. NB: both Z_R_start and Z_R_end must be inserted for the interval range to be created."
        elif self.clicked.get() == self.options[2]:
    ...
    def info_box6(self):
        if self.clicked.get() == self.options[0]:
            ...
            Text = "Insert value for Start interval of Imaginary part impedance values. NB: both Z_Im_start and Z_Im_end must be inserted for the interval range to be created."
        elif self.clicked.get() == self.options[2]:
    ...
    def info_box7(self):
        if self.clicked.get() == self.options[0]:
            ...
            Text = "Insert value for End interval of Imaginary part impedance values. NB: both Z_Im_start and Z_Im_end must be inserted for the interval range to be created."
        elif self.clicked.get() == self.options[2]:
    ...
    def info_box9(self):
        if self.clicked.get() == self.options[0]:
            ...
            Text = "To create circle fit. Number of indexes away from first index."
        elif self.clicked.get() == self.options[2]:
    ...
    def info_box10(self):
        if self.clicked.get() == self.options[0]:
            Text = "Number of decimals for values in output plots."
        elif self.clicked.get() == self.options[1]:
            Text = "To create circle fit. Number of indexes to the left of max of semicircle."
        elif self.clicked.get() == self.options[2]:
