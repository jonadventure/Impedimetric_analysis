...
class App:
    ...
    def info_box10(self):
        if self.clicked.get() == self.options[0]:
            ...
            Text = "Type the number of indexes away from the top of the semicircle that you want to create the circle fit on. Note, it is on the left of the semicircle."
        elif self.clicked.get() == self.options[2]:
